...
// Type: Sitecore.WFFM.Analytics.Model.FieldData
...
{
  [Obsolete("For compatibility with old data. Use Sitecore.WFFM.Abstractions.Analytics.FormData instead")]
  public class FieldData : Sitecore.WFFM.Abstractions.Analytics.FieldData
  {
  }
}
