...
// Type: Sitecore.Form.Web.UI.Controls.ValidateControl
...
{
  public abstract class ValidateControl : HelpControl
  {
    protected ValidateControl()
    {
    }

    protected ValidateControl(HtmlTextWriterTag tag)
      : base(tag)
    {
    }
    ...
    protected ValidatorCollection GetValidators()
    {
      ...
      validatorCollection.AddRange((IValidator[]) ValidateControl.GetValidators(this.InnerValidatorContainer));
      validatorCollection.AddRange((IValidator[]) ValidateControl.GetValidators(this.ValidatorContainer));
