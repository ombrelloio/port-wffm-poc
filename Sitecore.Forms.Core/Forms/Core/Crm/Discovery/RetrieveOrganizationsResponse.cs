...
// Type: Sitecore.Forms.Core.Crm.Discovery.RetrieveOrganizationsResponse
...
namespace Sitecore.Forms.Core.Crm.Discovery
{
  ...
  [DebuggerNonUserCode]
  [Serializable]
  public class RetrieveOrganizationsResponse : Response
  {
    private OrganizationDetail[] organizationDetailsField;

    public OrganizationDetail[] OrganizationDetails
    {
      get => this.organizationDetailsField;
      set => this.organizationDetailsField = value;
    }
  }
}
