...
// Type: Sitecore.Forms.Core.Crm.Discovery.RetrieveClientPatchesResponse
...
namespace Sitecore.Forms.Core.Crm.Discovery
{
  ...
  [DebuggerNonUserCode]
  [Serializable]
  public class RetrieveClientPatchesResponse : Response
  {
    private ClientPatchInfo[] patchInfoField;

    public ClientPatchInfo[] PatchInfo
    {
      get => this.patchInfoField;
      set => this.patchInfoField = value;
    }
  }
}
