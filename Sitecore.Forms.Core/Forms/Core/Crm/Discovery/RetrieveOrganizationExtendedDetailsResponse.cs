...
// Type: Sitecore.Forms.Core.Crm.Discovery.RetrieveOrganizationExtendedDetailsResponse
...
namespace Sitecore.Forms.Core.Crm.Discovery
{
  ...
  [DebuggerNonUserCode]
  [Serializable]
  public class RetrieveOrganizationExtendedDetailsResponse : Response
  {
    ...
    {
      get => this.organizationExtendedDetailsField;
      set => this.organizationExtendedDetailsField = value;
    }
  }
}
