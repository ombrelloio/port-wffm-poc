...
// Type: Sitecore.Forms.Core.Crm.RetrieveDuplicatesRequest
...
namespace Sitecore.Forms.Core.Crm
{
  ...
  public class RetrieveDuplicatesRequest : Request
  {
    ...
    {
      get => this.businessEntityField;
      set => this.businessEntityField = value;
    }

    public string MatchingEntityName
    {
      get => this.matchingEntityNameField;
      set => this.matchingEntityNameField = value;
    }

    public PagingInfo PagingInfo
    {
      get => this.pagingInfoField;
      set => this.pagingInfoField = value;
    }
