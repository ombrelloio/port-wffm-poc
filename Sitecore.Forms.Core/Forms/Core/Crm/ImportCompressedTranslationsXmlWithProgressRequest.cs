...
// Type: Sitecore.Forms.Core.Crm.ImportCompressedTranslationsXmlWithProgressRequest
...
namespace Sitecore.Forms.Core.Crm
{
  ...
  public class ImportCompressedTranslationsXmlWithProgressRequest : Request
  {
    ...
    {
      get => this.compressedTranslationsXmlField;
      set => this.compressedTranslationsXmlField = value;
    }
