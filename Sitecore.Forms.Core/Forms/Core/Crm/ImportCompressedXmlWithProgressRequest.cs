...
// Type: Sitecore.Forms.Core.Crm.ImportCompressedXmlWithProgressRequest
...
namespace Sitecore.Forms.Core.Crm
{
  ...
  public class ImportCompressedXmlWithProgressRequest : Request
  {
    ...
    {
      get => this.compressedCustomizationXmlField;
      set => this.compressedCustomizationXmlField = value;
    }
