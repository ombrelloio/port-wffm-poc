...
// Type: Sitecore.Forms.Core.Crm.Metadata.CreateOneToManyRequest
...
namespace Sitecore.Forms.Core.Crm.Metadata
{
  ...
  public class CreateOneToManyRequest : MetadataServiceRequest
  {
    ...
    {
      get => this.lookupField;
      set => this.lookupField = value;
    }

    public OneToManyMetadata OneToManyRelationship
    {
      get => this.oneToManyRelationshipField;
      set => this.oneToManyRelationshipField = value;
    }
  }
}
